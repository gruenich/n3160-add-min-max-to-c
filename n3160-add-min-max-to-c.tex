...
Status: Superseded by N3868\\
Document hosted at \url{https://github.com/gruenich/n3160-add-min-max-to-c}

\section*{Version history}
\textbf{2026-04-06}: Superseded by N3868 \textit{Add type-safe minimum and maximum type-gen\-eric macros} from Jens Gustedt,
\url{https://www.open-std.org/JTC1/SC22/WG14/www/docs/n3868.htm}
